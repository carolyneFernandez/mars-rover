...
*  Installer une extension sur votre navigateur qui désactive le cors :
    ...
    1.  [Firefox](https://addons.mozilla.org/fr/firefox/addon/access-control-allow-origin/)
    1.  [Chrome](https://chrome.google.com/webstore/detail/allow-cors-access-control/lhobafahddgcelffkeicbaginigeejlf)
    
    1.  Après l'installation, un petit icon apparaitra en haut à droite de votre navigateur. Cliquez dessus pour autoriser les requête multi-origin
